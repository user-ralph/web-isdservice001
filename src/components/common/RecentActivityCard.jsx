...
export default function RecentActivityCard() {
  ...
  const activities = [
    { 
      ...
      controlNo: "P00021087", 
      remarks: "Registered Asset #21087 (Dell Optiplex 7090) for Finance Dept.", 
    ...
    { 
      ...
      changeType: "Repair", 
      controlNo: "P00001102",
      remarks: "Replaced faulty HDD with 512GB SSD on PC #1102.", 
      user: "Jerick Miranda", 
      time: "45 mins ago",
      icon: <FaTools />,
      color: "text-warning",
    ...
    { 
      ...
      controlNo: "P00099321",
      remarks: "Installed AutoCAD 2025 and configured network license for Engr. Santos.", 
    ...
    { 
      ...
      changeType: "Scrap", 
      controlNo: "P00000091",
      remarks: "Decommissioned PC #0091 due to motherboard failure (Beyond Economic Repair).", 
